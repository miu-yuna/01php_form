<form action="confilm.php" method="post" name="form">
    <p>お問い合わせ内容をご入力の上、「確認画面へ」ボタンをクリックしてください。</p>
    <div>
        <label>お名前<span class="span">必須</span></label>
        <input type="text" name="name" placeholder="例）山田一郎" value="">
    </div>
    <div>
        <label>ふりがな<span class="span">必須</span></label>
        <input type="text" name="furigana" placeholder="例）やまだいちろう" value="">
    </div>
    <div>
